    ...
    : ControllerBase
{
    ...
    public async Task<IActionResult> Create([Required] [FromBody] AddCertificateModel model)
    {
    ...
    public async Task<IActionResult> Update(int id, [Required] [FromBody] UpdateCertificateModel model)
    {
        try
        {
            if (id != model.Id)
