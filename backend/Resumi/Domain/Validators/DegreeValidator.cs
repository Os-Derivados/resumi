...
public class DegreeValidator : IDomainValidator<Degree>
{
    ...
    private static void ValidateRequiredFields(Degree degree, ResultDictionary errors)
    {
    ...
    private static void ValidateFieldLengths(Degree degree, ResultDictionary errors)
    {
    ...
    private static void ValidateDegreeLevel(Degree degree, ResultDictionary errors)
    {
