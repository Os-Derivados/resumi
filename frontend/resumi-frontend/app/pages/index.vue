<template>
	<UContainer v-if="sessionUser"
		...
		<UMain>
			<UContainer>
				<UModal title="Criar Curriculo">
					<UButton label="Novo Curriculo" icon="i-custom-round-star"></UButton>
...
import UserComponent from '~/views/components/user-component.vue';
